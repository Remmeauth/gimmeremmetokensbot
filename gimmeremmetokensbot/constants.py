...
In a deal with REMME stuff, [Blockexplorer](https://blockexplorer.remme.io) can be useful. For testing purposes you are 
able to request a batch of tokens by keyboard below for newly created account just for you.
"""
